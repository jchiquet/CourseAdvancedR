...
## Use `ggplot2` in conjonction with other packages

![Remember the data process scheme?](../Rmd_files/tidyverse/figs/tidyverse_data_science.png){width="70%"}

The model/visualization part need constant wrangling/new arragement of your data set
