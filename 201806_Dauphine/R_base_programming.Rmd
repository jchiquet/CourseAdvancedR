...
Many ideas/examples inspired/stolen in the following books:
...
```{r functionals, child = paste0('functionals/', c("intro_functionals.Rmd", "closure.Rmd",  "lapply.Rmd", "anonymous_function.Rmd", "lapply_family.Rmd", "apply.Rmd", "Reduce.Rmd", "math_functionals.Rmd"))}
```
