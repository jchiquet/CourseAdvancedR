...
```{r, child = paste0('tidyverse/', c("readr.Rmd", "tidyr.Rmd", "dplyr.Rmd")), cache = FALSE}
```

# Manipulation, vizualization: `magrittr`, `purrr`, `ggplot2`   

```{r, child = paste0('tidyverse/', c("magrittr.Rmd", "purrr.Rmd", "ggplot2.Rmd")), cache = FALSE}
```
